  ...
  try {
    ...
    const loan = await prisma.featured_loans.update({
      ...
      data: {
        ...
        ...(showDPA !== undefined && { show_dpa: showDPA }),
        ...(dpaText !== undefined && { dpa_text: dpaText }),
        ...(learnMoreEnabled !== undefined && { learn_more_enabled: learnMoreEnabled }),
        ...(learnMoreUrl !== undefined && { learn_more_url: learnMoreUrl }),
        ...(learnMoreText !== undefined && { learn_more_text: learnMoreText }),
        updated_at: new Date(),
      },
      include: {
        featured_loans_features: {
    ...
    if (features !== undefined) {
      ...
      return successResponse({
        ...
        showDPA: updatedLoan!.show_dpa ?? true,
        dpaText: updatedLoan!.dpa_text ?? 'Down Payment Assistance Available',
        learnMoreEnabled: updatedLoan!.learn_more_enabled ?? false,
        learnMoreUrl: updatedLoan!.learn_more_url,
        learnMoreText: updatedLoan!.learn_more_text ?? 'Learn More',
