    ...
    <div className="max-w-7xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-start">
        ...
        <div className={`rounded-lg border ${isDark ? 'bg-gray-800/80 border-gray-700/60' : 'bg-white border-gray-200'}`}>
          {/* Program + Batch Name */}
          <div className={`px-5 pt-5 pb-4 border-b ${isDark ? 'border-gray-700/60' : 'border-gray-200'}`}>
        ...
        <div className={`rounded-lg border ${isDark ? 'bg-gray-800/80 border-gray-700/60' : 'bg-white border-gray-200'}`}>
          ...
          {batchRecords.length === 0 ? (
            <div className="px-5 py-10 text-center">
              <svg className={`w-8 h-8 mx-auto mb-2 ${isDark ? 'text-gray-600' : 'text-gray-300'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
